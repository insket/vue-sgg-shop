            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="commit">
                    <i class="command"
                      >已有<span>{{ Math.floor(good.price * 1.5 - 200) }}</span
                      >人评价</i
                    >
                  </div>
                  <div class="operate">
...
export default {
  ...
  beforeMount() {
    // 合并对象
    this.searchParams.category1Id = this.$route.query.catname1id;
    this.searchParams.category2Id = this.$route.query.catname2id;
